        ...
        <div class="col-12">
            <div class="card">
                <div class="justify-content-end d-flex">
                    <x-search.table-search action="#" method="get" name="search" value=""
                        btnClass="search_btn" />
                </div>
                            ...
                            <tbody id="candidatesData">
                                ...
                                @foreach ($assignProjects as $p)
                                    <tr>
                                        ...
                                        <td>{{ $p->assignby->name }}</td>

                                        <td>
                                            <a href="{{route('formDetail.create',['c_id'=>$p->customer->id,'p_id'=>$p->project->id])}}" class="btn btn-info btn-sm">{{$p->project->form_name}}</a>
                                        </td>
