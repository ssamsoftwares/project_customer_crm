                ...
                <div class="card-body">
                        ...
                        <div class="basic-form-details">
                            <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="form_name" value="{{ $project->form_name ?? null }}_p_{{ $project->id ?? null }}">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-8">
                                ...
                                <input type="file" name="office_images[]" id="office_images" class="form-control" multiple>
                            </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <input type="file" name="product_services_photos[]" id="product_services_photos" class="form-control" multiple>
                            </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <input type="file" name="completed_work[]" id="completed_work" class="form-control" multiple>
                            </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <input type="file" name="local_ads_images[]" id="local_ads_images" class="form-control" multiple>
                            </div>
