                ...
                <div class="card-body">
                    ...
                    <div class="basic-form-details">
                        ...
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Basic Details </button>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-12">
                                    <x-form.textarea name="business_description"
                                        label="Business Description (750 Characters)"
                                        value="{{ $form_data->business_description ?? null }}" />
                                </div>

                                <div class="col-lg-12">
                                    <x-form.textarea name="keywords_related_to_business"
                    ...
                    <div class="contact-details">
                        ...
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('Contact Details') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Contact Details </button>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4">
                                    <x-form.input name="official_email_address" label="Official Email Address"
                                        type="email" value="{{ $form_data->official_email_address ?? null }}" />
                                </div>
                                ...
                                <div class="col-lg-3">
                                    <x-form.input name="city" label="City"
                                        value="{{ $form_data->city ?? null }}" />
                                </div>

                                <div class="col-lg-3">
                                    <x-form.input name="state" label="State"
                                        value="{{ $form_data->state ?? null }}" />
                                </div>
                    ...
                    <div class="Timing">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('TIMINGS') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Timings </button>
                            </div>
                    ...
                    <div class="service-details">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('Services Details') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Services Details </button>
                            </div>
                    ...
                    <div class="google-messages">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('Google Messages (if needed)') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Google Messages Details </button>
                            </div>
                    ...
                    <div class="Images">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('IMAGES') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Images </button>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="file" name="exterior[]" id="exterior" class="form-control"
                                        multiple>
                                </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="file" name="interior[]" id="interior" class="form-control"
                                        multiple>
                                </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="file" name="work_place[]" id="work_place" class="form-control"
                                        multiple>
                                </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="file" name="machines[]" id="machines" class="form-control"
                                        multiple>
                                </div>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <input type="file" name="completed_work[]" id="completed_work"
                                        class="form-control" multiple>
                                </div>
                    ...
                    <div class="current-office-related-questions">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $form_data->id ?? null }}">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('Current Office Related Questions') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i> Current Office Related Questions </button>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4">
                                    <x-form.select name="in_store_pickup_online"
                                        label="In-store pick-up for online orders ?" chooseFileComment="--Select option--"
                                        :options="[
                                            'yes' => 'Yes',
                                            'no' => 'No',
                    ...
                    <div class="payment-related-questions">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $form_data->id ?? null }}">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('Payment Related Questions') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i>Payment Related Questions </button>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-4">
                                    <x-form.select name="mastercard" label="Mastercard"
                                        chooseFileComment="--Select option--" :options="[
                                            'yes' => 'Yes',
                                            'no' => 'No',
                    ...
                    <div class="social-profile-links">
                        <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="align-content-center">{{ __('Social Profile Links') }}</h5>
                                <button type="submit" class="btn btn-primary float-end">Add <i
                                        class="fa fa-pencil-square-o"></i>Social Profile Links </button>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-12">
                                    {{-- <x-form.textarea name="other_social_media_links" label="Other Social media links"
                                        ...
                                        {{-- <textarea name="other_social_media_links" id="other_social_media_links" cols="30" rows="10" class="form-control">{{ $form_data->other_social_media_links ?? null }}</textarea> --}}


                                        <textarea name="other_social_media_links" id="other_social_media_links" cols="30" rows="10" class="form-control">{{ $form_data->other_social_media_links ?? '' }}</textarea>
