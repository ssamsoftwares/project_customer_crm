...
@section('content')
    ...
    <b> {{ __('Customer Name -') }} {{$customer->name ? Str::ucfirst($customer->name) : ''}}</b>
                    ...
                    <form method="post" action="{{ route('formDetail.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-header text-primary">
                                <h5 class="mb-2">{{ __('Basic Details') }}</h5>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            {{-- Brand Logo --}}
                            {{-- <div class="col-lg-8">
                                <x-form.input name="brand_logo" label="Brand Logo" type="file" />
                            </div>

                            <div class="col-lg-4 mt-4">
                              <img src="{{ $form_data->brand_logo ?? null }}" alt="Brand Logo" width="70">
                            </div> --}}

                            <div class="col-lg-8">
                                <label for="brand_logo">Brand Logo</label>
                                <input type="file" accept="image/*" name="brand_logo" id="brand_logo"
                                    class="form-control" onchange="loadFile(event, 'preview_brand_logo')">
                            </div>
                            <div class="col-lg-4 mt-lg-2">
                                ...
                                @if (!empty($form_data->brand_logo))
                                    <img src="{{ asset($form_data->brand_logo) }}" id="preview_brand_logo" alt=""
                                        width="50" height="50">
                                @else
                                    <img src="" id="preview_brand_logo" alt="" style="max-width: 50%; max-height: 100px;">
                                @endif
                            </div>
                        ...
                        <div class="row mt-4">
                            ...
                            {{--  Office images --}}
                            <div class="col-lg-8">
                                <x-form.input name="office_images[]" label="Office images" type="file" />
                            </div>
                            ...
                            {{--  Exterior --}}
                            <div class="col-lg-8">
                                <x-form.input name="exterior[]" label="" type="file" />
                            </div>
                            ...
                            {{--  Interior --}}
                            <div class="col-lg-8">
                                <x-form.input name="interior[]" label="Interior" type="file" />
                            </div>
                            ...
                            {{--  Work place --}}
                            <div class="col-lg-8">
                                <x-form.input name="work_place[]" label="Work place" type="file" />
                            </div>
                            ...
                            {{--  Machines --}}
                            <div class="col-lg-8">
                                <x-form.input name="machines[]" label="Machines" type="file" />
                            </div>
                            ...
                            <div class="col-lg-8">
                                <x-form.input name="product_services_photos[]" label="Product / Services Photos ( if any)"
                                    type="file" />
                            </div>
                            ...
                            {{--  Completed work --}}
                            <div class="col-lg-8">
                                <x-form.input name="completed_work[]" label="Completed work" type="file" />
                            </div>
                            ...
                            <div class="col-lg-8">
                                <x-form.input name="local_ads_images[]" label="Local ads images (if any)" type="file" />
                            </div>
                        ...
                        <div>
                            <button class="btn btn-primary mt-2"
                                type="submit">{{ __('Submit Form Details') }}</button>
                        </div>
                    </form>
                </div>
            </div>
